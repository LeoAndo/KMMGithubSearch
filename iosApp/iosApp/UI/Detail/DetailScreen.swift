...
struct DetailScreen_Previews: PreviewProvider {
    static var previews: some View {
        let detailData: RepositoryDetail = RepositoryDetail(name: "repo01", ownerAvatarUrl: "https://avatars.githubusercontent.com/u/14101776?v=4", stargazersCount: "100", forksCount: "200", openIssuesCount: "300", watchersCount: "400", language: "Dart")
        let detailErrorData: RepositoryDetail = RepositoryDetail(name: "repo01", ownerAvatarUrl: "errorUrl", stargazersCount: "100", forksCount: "200", openIssuesCount: "300", watchersCount: "400", language: nil)
